...
series_order: 6
---
I'll be reworking my proxy setup, as originally I installed one directly on the [Immich Installation](/blog/stable/homelab/v1/immich-installation/) server. Instead, we want one central reverse proxy which coordinates traffic between all of my application servers.
...
Repeat for other services. So far, just [Jellyfin](/blog/stable/homelab/v1/jellyfin/) and this nginx proxy manager:
