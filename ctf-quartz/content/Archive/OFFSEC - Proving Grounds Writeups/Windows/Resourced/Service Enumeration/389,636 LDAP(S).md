...
Anonymous LDAP bind:
```
ldapsearch -x -H ldap://$IP -b "DC=ResourceDC,DC=resourced,DC=local"
```
...
#
# LDAPv3
# base <DC=ResourceDC,DC=resourced,DC=local> with scope subtree
# filter: (objectclass=*)
# requesting: ALL
#
